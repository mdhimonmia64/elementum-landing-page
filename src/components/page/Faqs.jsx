    ...
    <div className="bg-base-100 text-base-content">
      <section className="container mx-auto px-6 pt-20 pb-16">
        <div className="text-center">
          ...
          <p className="pt-8 text-lg leading-8">
      ...
      <section className="pb-24">
        <div className="max-w-5xl mx-auto px-6">
          <div className="bg-neutral text-neutral-content rounded-[40px] p-14 text-center">
            <FaEnvelope className="mx-auto text-primary mb-6" size={45} />
            <h2 className="text-5xl hero-font">Still Have Questions?</h2>
